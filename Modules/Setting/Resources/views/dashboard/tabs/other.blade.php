<div class="tab-pane fade" id="other">
    ...
    <div class="col-md-10">
                ...
                <select name="other[privacy_policy]" class="form-control select2">
                    ...
                    @foreach ($pages as $page)
                        <option value="{{ $page['id'] }}"
                            {{ setting('other.privacy_policy') == $page->id ? ' selected="" ' : '' }}>
                            {{ $page->title }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <select name="other[terms]" class="form-control select2">
                    ...
                    @foreach ($pages as $page)
                        <option value="{{ $page['id'] }}"
                            {{ setting('other.terms') == $page->id ? ' selected="" ' : '' }}>
                            {{ $page->title }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <select name="other[about_us]" class="form-control select2">
                    ...
                    @foreach ($pages as $page)
                        <option value="{{ $page['id'] }}"
                            {{ (setting('other.about_us')) && setting('other.about_us') == $page->id ? ' selected="" ' : '' }}>
                            {{ $page->title }}
                        </option>
                    @endforeach
                </select>
                ...
                <select name="other[shipping_company]" class="form-control select2">
                    ...
                    @foreach ($companies as $company)
                        <option value="{{ $company['id'] }}"
                            {{ (setting('other.shipping_company')) && setting('other.shipping_company') == $company->id ? ' selected="" ' : '' }}>
                            {{ $company->name }}
                        </option>
                    @endforeach
                </select>
                ...
                <div class="mt-radio-inline">
                    <label class="mt-radio mt-radio-outline">
                        ...
                        <input type="radio" name="other[add_shipping_company]" value="1"
                            @if (setting('other.add_shipping_company') == 1) checked @endif>
                        <span></span>
                    </label>
                    <label class="mt-radio mt-radio-outline">
                        {{ __('setting::dashboard.settings.form.no') }}
                        <input type="radio" name="other[add_shipping_company]" value="0"
                            @if (setting('other.add_shipping_company') == 0) checked @endif>
                        <span></span>
                    </label>
                </div>
            </div>
            ...
            <div class="col-md-9">
                <select name="default_vendor" class="form-control select2">
                    ...
                    @foreach ($activeVendors as $vendor)
                        <option
                            value="{{ $vendor['id'] }}" {{( setting('default_vendor') == $vendor->id) ? ' selected="" ' : ''}}>
                            {{ $vendor->title }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="form-group">
            <label class="col-md-2">
                {{ __('setting::dashboard.settings.form.selling_on_site') }}
            </label>
            <div class="col-md-9">
                <div class="mt-radio-inline">
                    <label class="mt-radio mt-radio-outline">
                ...
                <div class="mt-radio-inline">
                    <label class="mt-radio mt-radio-outline">
                        ...
                        <input type="radio" name="other[is_multi_vendors]" value="1"
                            @if (setting('other.is_multi_vendors') == 1) checked @endif>
                        <span></span>
                    </label>
                    <label class="mt-radio mt-radio-outline">
                        {{ __('setting::dashboard.settings.form.no') }}
                        <input type="radio" name="other[is_multi_vendors]" value="0"
                            @if (setting('other.is_multi_vendors') == 0) checked @endif>
                        <span></span>
                    </label>
                </div>
                ...
                <div class="mt-radio-inline">
                    <label class="mt-radio mt-radio-outline">
                        ...
                        <input type="radio" name="other[select_shipping_provider]" value="shipping_company"
                            @if (setting('other.select_shipping_provider') == 'shipping_company') checked @endif>
                        <span></span>
                    </label>
                    <label class="mt-radio mt-radio-outline">
                        ...
                        <input type="radio" name="other[select_shipping_provider]" value="vendor_delivery"
                            @if (setting('other.select_shipping_provider') == 'vendor_delivery') checked @endif>
                        <span></span>
                    </label>
                </div>
            </div>
                ...
                <div class="mt-radio-inline">
                    <label class="mt-radio mt-radio-outline">
                        ...
                        <input type="radio" name="other[enable_subscriptions]" value="1"
                            @if (setting('other.enable_subscriptions') == 1) checked @endif>
                        <span></span>
                    </label>
                    <label class="mt-radio mt-radio-outline">
                        {{ __('setting::dashboard.settings.form.no') }}
                        <input type="radio" name="other[enable_subscriptions]" value="0"
                            @if (setting('other.enable_subscriptions') == 0) checked @endif>
                        <span></span>
                    </label>
                </div>
            </div>
