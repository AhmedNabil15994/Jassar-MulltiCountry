                ...
                <div class="mt-radio-inline">
                    <label class="mt-radio mt-radio-outline">
                        ...
                        <input onchange="paymentModeSwitcher('upay_switch','testModelData_upay')" type="radio" name="payment_gateway[upayment][payment_mode]" value="test_mode"
                                @if (Setting::get('payment_gateway.upayment.payment_mode') != 'live_mode')
                                checked
                                @endif>
                        <span></span>
                    </label>
...
<div class="row">
    <div class="col-md-7 col-md-offset-2 upay_switch" id="testModelData_upay"
            style="{{ Setting::get('payment_gateway.upayment.payment_mode') == 'live_mode' ? 'display: none': 'display: block' }}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="payment_gateway[upayment][test_mode][MERCHANT_ID]"
                    value="{{ Setting::get('payment_gateway.upayment.test_mode.MERCHANT_ID') ?? '' }}"/>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="payment_gateway[upayment][test_mode][API_KEY]"
                    value="{{ Setting::get('payment_gateway.upayment.test_mode.API_KEY') ?? '' }}"/>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="payment_gateway[upayment][test_mode][USERNAME]"
                    value="{{ Setting::get('payment_gateway.upayment.test_mode.USERNAME') ?? '' }}"/>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"
                    ...
                    value="{{ Setting::get('payment_gateway.upayment.test_mode.PASSWORD') ?? '' }}"/>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"
                    ...
                    value="{{ Setting::get('payment_gateway.upayment.test_mode.charges') ?? '' }}"/>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"
                    ...
                    value="{{ Setting::get('payment_gateway.upayment.test_mode.cc_charges') ?? '' }}"/>
        </div>
    </div>

    <div class="col-md-7 col-md-offset-2 upay_switch" id="liveModelData_upay"
            style="{{ Setting::get('payment_gateway.upayment.payment_mode') == 'live_mode' ? 'display: block': 'display: none' }}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="payment_gateway[upayment][live_mode][MERCHANT_ID]"
                    value="{{ Setting::get('payment_gateway.upayment.live_mode.MERCHANT_ID') ?? '' }}"/>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="payment_gateway[upayment][live_mode][API_KEY]"
                    value="{{ Setting::get('payment_gateway.upayment.live_mode.API_KEY') ?? '' }}"/>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="payment_gateway[upayment][live_mode][USERNAME]"
                    value="{{ Setting::get('payment_gateway.upayment.live_mode.USERNAME') ?? '' }}"/>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="payment_gateway[upayment][live_mode][PASSWORD]"
                    value="{{ Setting::get('payment_gateway.upayment.live_mode.PASSWORD') ?? '' }}"/>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="payment_gateway[upayment][live_mode][IBAN]"
                    value="{{ Setting::get('payment_gateway.upayment.live_mode.IBAN') ?? '' }}"/>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"
                    ...
                    value="{{ Setting::get('payment_gateway.upayment.live_mode.charges') ?? '' }}"/>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"
                    ...
                    value="{{ Setting::get('payment_gateway.upayment.live_mode.cc_charges') ?? '' }}"/>
        </div>
    ...
    <div class="col-md-7 col-md-offset-2">
        ...
        @foreach (array_keys(config('laravellocalization.supportedLocales')) as $code)
            ...
            Setting::get('payment_gateway.upayment.title_'.$code)) !!}
        ...
        (Setting::get('payment_gateway.upayment.status') == 'on' ? 'checked' : '') => ''
        ]) !!}
        
        @include('core::dashboard.shared.file_upload', [
            'name' => 'images[upayment_logo]',
            'imgUploadPreviewID' => 'settingFavicon',
            'image' => Setting::get('upayment_logo') ?? null,
        ])
    </div>
</div>