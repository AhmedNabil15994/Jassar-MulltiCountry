        ...
        <div class="col-md-7 col-md-offset-2" id="testModelData"
            ...
            {{--<div class="form-group">
                ...
                <input type="text" class="form-control" name="payment_gateway[upayment][test_mode][IBAN]"
                       value="{{ setting('payment_gateway.upayment.test_mode.IBAN') ?? '' }}"/>
            </div>--}}
                ...
                <div class="col-md-8">
                    <label class="checkbox-inline">
                        <input type="checkbox"
                               ...
                               @if (in_array('cash', setting('other.supported_payments') ?? []))
                               checked
                               @endif
                    ...
                    <label class="checkbox-inline">
                        <input type="checkbox"
                               name="other[supported_payments][]"
                               @if (in_array('online', setting('other.supported_payments') ?? []))
                               checked
                               @endif
