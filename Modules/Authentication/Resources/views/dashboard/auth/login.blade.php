<html>
    ...
    <body class="login">
        <div class="content">
            <form class="login-form" action="{{ route('dashboard.login_post') }}" method="POST">
                {{ csrf_field() }}
                ...
                <a class="link-muted" href="{{ route('dashboard.password.request') }}">
                    {{ __('authentication::dashboard.login.form.forget_password') }}
                </a>
