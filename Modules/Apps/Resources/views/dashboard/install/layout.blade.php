            ...
            <div class="wrapper">
                <div class="left-sidebar clearfix">
                    <ul class="list-inline">
                        <li class="{{ !isset($completed) ? 'active' : 'complete' }}">
                            {{ __('setting::dashboard.settings.form.tabs.app') }}
                        </li>

                        <li class="{{ isset($current) && $current == 'country' ? 'active' : (isset($completed) && in_array('country',(array)$completed) ? 'complete' : '') }}">
                            
                            @lang('Country settings')
                        </li>

                        <li class="{{ isset($current) && $current == 'logo' ? 'active' : (isset($completed) && in_array('logo',(array)$completed) ? 'complete' : '') }}">
                            
                            @lang('Site Logos')
                        </li>

                        <li class="{{ isset($current) && $current == 'complete' ? 'active' : (isset($completed) && in_array('complete',(array)$completed) ? 'complete' : '') }}">
                            @lang('Complete')
                        </li>
                    </ul>
                </div>
