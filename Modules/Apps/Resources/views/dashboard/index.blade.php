            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 yellow-casablanca" href="#">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="{{$activeProducts}}">{{$activeProducts}}</span>
                            </div>
                            <div class="desc">{{ __('apps::dashboard.home.statistics.products') }}</div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="{{$reviewProductsCount}}">{{$reviewProductsCount}}</span>
                            </div>
                            <div class="desc">{{ __('apps::dashboard.home.statistics.inreview-products') }}</div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 yellow-gold" href="#">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="{{$ordersCount['completed_orders']}}">{{$ordersCount['completed_orders']}}</span>
                            </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 yellow-lemon" href="#">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="{{$ordersCount['current_orders']}}">{{$ordersCount['current_orders']}}</span>
                            </div>
                            <div class="desc">{{ __('apps::dashboard.home.statistics.current_orders') }}</div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 yellow" href="#">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="{{$ordersCount['all_orders']}}">{{$ordersCount['all_orders']}}</span>
                            </div>
                            <div class="desc">{{ __('apps::dashboard.home.statistics.all_orders') }}</div>
                        </div>
                    </a>
                </div>
            </div>
