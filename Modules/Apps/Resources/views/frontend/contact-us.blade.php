                ...
                <div class="col-md-6 contact-details">
                    <ul class="contact-details">
                        ...
                        @if(setting('contact_us.mobile'))
                            <li>
                                <i class="ti-mobile"></i> <strong>{{ __('apps::frontend.contact_us.info.mobile')}}
                                    :</strong>
                                <span>{{ setting('contact_us.mobile') }} </span>
                            </li>
                        @endif

                        @if(setting('contact_us.technical_support'))
                            <li>
                                <i class="ti-headphone-alt"></i>
                                <strong>{{ __('apps::frontend.contact_us.info.technical_support')}}:</strong>
                                <span>{{ setting('contact_us.technical_support') }} </span>
                            </li>
                        @endif
                        ...
                        <li>
                            ...
                            <span><a href="mailto:{{ setting('contact_us.email') }}">{{ setting('contact_us.email') }}</a></span>
                        </li>
                    </ul>
                    <div class="footer-social mt-30 pt-30">
                        <a href="{{ setting('social.facebook') ?? '#' }}" target="_blank" class="social-icon">
                            <i class="ti-facebook"></i>
                        </a>
                        <a href="{{ setting('social.instagram') ?? '#' }}" target="_blank" class="social-icon">
                            <i class="ti-instagram"></i>
                        </a>
                        <a href="{{ setting('social.linkedin') ?? '#' }}" target="_blank" class="social-icon">
                            <i class="ti-linkedin"></i>
                        </a>
                        <a href="{{ setting('social.twitter') ?? '#' }}" target="_blank" class="social-icon">
