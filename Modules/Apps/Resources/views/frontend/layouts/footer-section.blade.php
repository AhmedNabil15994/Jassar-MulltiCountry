            ...
            <div class="row">
                <div class="col-md-4 col-12 footer-logo-icon">
                    <img class="footer-logo"
                        src="{{ setting('images.white_logo') ? url(setting('images.white_logo')) : url('frontend/images/footer-logo.png') }}" />
                    <div class="links">
                        <ul>
                            {{-- <li>{{ setting('address.' . locale()) }}</li> --}}
                            <li>{{ setting('contact_us.email') }}</li>
                        </ul>
                    </div>
