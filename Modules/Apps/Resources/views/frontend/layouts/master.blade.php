...
<body>
    ...
    {{-- <a href="https://wa.me/{{ setting('contact_us.whatsapp') }}" data-toggle="tooltip" data-placement="top"
   ...
   class="whatsapp-chat no-print">
    ...
    <a href="https://wa.me/{{ setting('contact_us.whatsapp') }}" class="whatsapp-chat no-print"
