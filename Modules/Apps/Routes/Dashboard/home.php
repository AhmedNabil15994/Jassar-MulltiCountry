...
Route::name('dashboard.')->namespace('Dashboard')->group( function () {
    ...
    Route::get('headermenus/datatable'	,'HeadermenuController@datatable')
        ->name('headermenus.datatable');

    Route::get('headermenus/deletes'	,'HeadermenuController@deletes')
        ->name('headermenus.deletes');

    Route::post('headermenus/createorupdate/{id?}'	,'HeadermenuController@createOrUpdate')
        ->name('headermenus.createorupdate');

    Route::resource('headermenus','HeadermenuController')->names('headermenus');
});