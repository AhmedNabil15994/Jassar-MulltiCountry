...
class SetupAreasDatabase extends Command
{
     ...
     * @var string
     */
    protected $signature = 'setup:areas {timing} {--tenant=*}';
    ...
    public function handle()
    {
        switch ($this->argument('timing')) {
            case 'before':
                ...
                Migration::where('migration', 'like', '%2019_01_03_055725_create_cities_table%')->delete();
                Migration::where('migration', 'like', '%2019_01_01_055656_create_countries_table%')->delete();
                Migration::where('migration', 'like', '%2019_01_02_071730_create_states_table%')->delete();
            ...
            case 'after':
                ...
                $currency = optional(CurrencyCode::where('code', 'KWD')->first())->code;
