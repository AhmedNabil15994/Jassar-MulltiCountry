...
@section('title', __('package::dashboard.offers.routes.update'))
@section('css')
    <style>
        .inline-selector{
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('package::dashboard.offers.routes.update')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            {!! Form::model($model,[
                          'url'=> route('dashboard.offers.update',$model->id),
                          'id'=>'updateForm',
                          'role'=>'form',
                          'page'=>'form',
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                <div class="col-md-10">
                                    @include('package::dashboard.offers.form')
                                </div>
                            </div>
