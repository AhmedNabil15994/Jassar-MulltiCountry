...
use Modules\User\Components\Address\Content;
use Modules\User\Components\Address\Card;
use Modules\User\Components\Address\Modal;
use Modules\User\Components\UserMenu;
...
class UserServiceProvider extends ServiceProvider
{
    ...
    {
        Blade::component('dukaan-user-menu', UserMenu::class);
        Blade::component('dukaan-address-card', Card::class);
        Blade::component('dukaan-address-content', Content::class);
        Blade::component('dukaan-address-modal', Modal::class);
    }
