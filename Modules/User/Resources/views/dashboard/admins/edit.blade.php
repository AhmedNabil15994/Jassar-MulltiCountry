                                                ...
                                                <select class="form-control select2" name="setting[countries][]" multiple>
                                                    ...
                                                    @foreach($countries as $country)
                                                        @if(in_array($country->id , setting('supported_countries')))
                                                            <option data-currency="{{$country->currency->code}}" value="{{$country->id}}" {{in_array($country->id,$user->setting->countries ?? [] )  ? 'selected' : '' }}>{{$country->title}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                <div class="help-block"></div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="mt-checkbox-list">
                                                    ...
                                                    @if (auth()->user()->tocaan_perm)
                                                        <label class="mt-checkbox">
                                                            <input type="checkbox" name="tocaan_perm"
                                                                {{ $user->tocaan_perm ? 'checked' : '' }} value="1">
                                                            Tocaan Role
                                                            <span></span>
                                                        </label>
                                                    @endif
