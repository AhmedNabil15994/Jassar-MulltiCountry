        ...
        <div class="page-content">
            ...
            <div class="row">
                <form id="form" role="form" class="form-horizontal form-row-seperated" method="post"
                    enctype="multipart/form-data" action="{{ route('dashboard.admins.store') }}">
                    @csrf
                    <div class="col-md-12">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control select2" name="setting[countries][]" multiple>
                                                    @foreach($countries as $country)
                                                        @if(in_array($country->id , setting('supported_countries')))
                                                            <option data-currency="{{$country->currency->code}}" value="{{$country->id}}" {{in_array($country->id,auth()->user()->setting->countries ?? [] )  ? 'selected' : ''}}>{{$country->title}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                <div class="help-block"></div>
