...
Route::group(['prefix' => 'profile', 'middleware' => 'auth'], function () {
    ...
    Route::post('/update-password', 'FrontEnd\UserController@updatePassword')
        ->name('frontend.profile.update.password');
    ...
    Route::group(['prefix' => 'addresses'], function () {
        ...
        Route::get('set-default/{id}', 'FrontEnd\UserController@setAddressAsDefault')
            ->name('frontend.profile.address.set-default');
