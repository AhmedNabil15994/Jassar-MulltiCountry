...
{{--                                        ,['autocomplete'=>'off'])!!}--}}
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select id="filterCountryId" name="countries[]" class="searchableSelect form-control select2" multiple>
                                                        <option value=""></option>
                                                        @foreach($countries as $code => $country)
                                                            @if((auth()->user()->is_internal && in_array($country->id , setting('supported_countries'))) ||
                                                                ...
                                                                {{ in_array($country->id,$company->countries->pluck('id')->toArray() ?? []) ? 'selected' : ''}}>{{$country->title}}</option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                </div>
