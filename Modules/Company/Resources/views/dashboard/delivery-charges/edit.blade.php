...
@section('scripts')
    <script>
       ...
       function freeDelivery(element){
           if($(element).is(':checked')){
               $(element).parents('td').find('.form-control.min-order-for-free-delivery-input').css('visibility','visible');
           }else{
               $(element).parents('td').find('.form-control.min-order-for-free-delivery-input').css('visibility','hidden');
           }
       }
