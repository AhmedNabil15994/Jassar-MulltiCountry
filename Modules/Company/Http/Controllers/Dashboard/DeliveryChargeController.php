...
class DeliveryChargeController extends Controller
{
    ...
    public function edit($countryPrefix,$id , $country)
    {
        $country = Country::whereIn('id',setting('supported_countries'))->findOrFail($country);
        ...
        $min_order_for_free_delivery = $company->deliveryCharge()->FilterWithCountry($country->id)->pluck('min_order_for_free_delivery', 'state_id')->toArray();

        return view('company::dashboard.delivery-charges.edit', compact('country','company', 'charges', 'times','statuses','min_order_amount','min_order_for_free_delivery'));
    }

    public function getStates($countryPrefix,$city,$company)
    {
        ...
        $html = view('company::dashboard.delivery-charges.components.states', compact('city','charges','times','statuses','min_order_amount','min_order_for_free_delivery'))->render();

        return response()->json(compact('html'));
    }

    public function update(DeliveryChargeRequest $request, $countryPrefix,$companyId)
    {
        try {
