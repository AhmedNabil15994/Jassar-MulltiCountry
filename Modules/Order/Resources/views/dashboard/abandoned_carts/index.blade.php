...
@section('title', __('order::dashboard.abandoned_carts.index.title'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('order::dashboard.abandoned_carts.index.title')}}</a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">
                                    {{__('order::dashboard.abandoned_carts.index.title')}}
                                </span>
                            </div>
                        </div>
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    'fnDrawCallback': function (data) {
                        ...
                        {{--  $('#total_unconfirmed_cash_orders').html(data.json.recordsUnconfirmedTotalSum);  --}}
                    },
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.abandoned_carts.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
...
responsivePriority:1,
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                // Show
                                var showUrl = '{{ route("dashboard.abandoned_carts.show", ":id") }}';
                                showUrl = showUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.abandoned_carts.destroy", ":id") }}';
                                ...
                                return `
                                        ...
                                        @endpermission
                                        @permission('delete_abandoned_carts')
