                                    ...
                                    <table class="table table-hover">
                                                        ...
                                                        @if ($product->product_id)
                                                            <a
                                                                ...
                                                                <img class="product_photo"
                                                                    src="{{ $product->product->getFirstMediaUrl('images') }}"
                                                ...
                                                <tr>
                                                    <td class="notbold text-left">
                                                        ...
                                                        @if ($package->package_id)
                                                            <a
                                                                href="{{ route('dashboard.packages.edit', $package->package->id) }}">
                                                                <img class="product_photo"
                                                                     src="{{ $package->package->getFirstMediaUrl('images') }}"
                                                                     width="39px" style="margin: 0px 2px;">
                                                                <span>
                                                                    {{ $package->package->title }}
                                                                    @foreach($package->package->products as $packageProduct)
                                                                        <br><a href="{{ route('dashboard.products.edit', $packageProduct->id) }}" target="_blank">{{$packageProduct->title . ' ' . $packageProduct->price}}</a>
                                                                    @endforeach
                                                                </span>
                                                            </a>
                                                        @endif
                                                    ...
                                                    <td class="text-left notbold"> {{ $package->qty ?? 1 }}
                                                    </td>
                                                    <td class="text-left notbold">
                                                        {{ $package->total }}
                                                    </td>
                                            ...
                                            @foreach ($order->orderOffers as $offer)
                                                <tr>
                                                    <td class="notbold text-left">
                                                        ...
                                                        @if ($offer->offer_id)
                                                            <a
                                                                href="{{ route('dashboard.offers.edit', $offer->offer->id) }}">
                                                                <img class="product_photo"
                                                                     src="{{ $offer->offer->getFirstMediaUrl('images') }}"
                                                                     width="39px" style="margin: 0px 2px;">
                                                                <span>
                                                                    {{ $offer->offer->title }}
                                                                    @foreach($offer->offer->products as $offerProduct)
                                                                        <br><a href="{{ route('dashboard.products.edit', $offerProduct->id) }}" target="_blank">{{$offerProduct->title . ' ' . $offer->offer->qty.'x'}}</a>
                                                                    @endforeach
                                                                    @foreach($offer->offer->freeProducts as $freeProduct)
                                                                        @foreach(json_decode($offer->settings)->selectedProducts as $selectedItem)
                                                                            @if($selectedItem->product_id == $freeProduct->id)
                                                                                <br><a href="{{ route('dashboard.products.edit', $freeProduct->id) }}" target="_blank">{{$freeProduct->title . ' ' . $selectedItem->qty.'x'}}</a>
                                                                            @endif
                                                                        @endforeach
                                                                    @endforeach
                                                                </span>
                                                    ...
                                                    <td class="text-left notbold"> {{ $offer->qty ?? 1 }}
                                                    </td>
                                                    <td class="text-left notbold">
                                                        {{ $offer->total }}
                                                    </td>
                                        ...
                                        <thead>
                                            ...
                                            <tr
                                                ...
                                                <th></th>
                                                <th></th>
                                                <th class="text-left bold">{{ number_format($order->original_subtotal - $order->total,3) }}</th>
                                            </tr>
                                            <tr>
                                                <th class="text-left bold">
                                ...
                                <div class="col-md-12">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            {{ $order->payment_confirmed_at ? date('Y-m-d / H:i:s', strtotime($order->payment_confirmed_at)) : '---' }}</li>
                                    </ul>
                                </div>
                            </div>
                        @endif
