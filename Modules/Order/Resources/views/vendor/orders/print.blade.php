    ...
    <div class="container mt-4 mb-4">
        ...
        <div class="row hidden-print">
            <div class="col-md-12 text-center mb-3">
                ...
                <a href="{{ route('vendor.current_orders.index') }}" class="btn btn-danger btn-sm">
                    {{__('apps::dashboard.general.back_btn')}}
                </a>
                @else
                <a href="{{ route('vendor.all_orders.index') }}" class="btn btn-danger btn-sm">
                    {{__('apps::dashboard.general.back_btn')}}
                </a>
                @endif
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-2 text-right">
                <img src="{{ setting('images.white_logo') ? url(setting('images.white_logo')) : url('frontend/images/footer-logo.png') }}"
