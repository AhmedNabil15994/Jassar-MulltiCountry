...
Route::group(['prefix' => 'abandoned-carts'], function () {
    ...
    Route::get('/', 'Dashboard\OrderController@getAbandonedCarts')
        ->name('dashboard.abandoned_carts.index')
        ->middleware(['permission:show_orders']);

    Route::get('datatable', 'Dashboard\OrderController@abandonedCartsDatatable')
        ->name('dashboard.abandoned_carts.datatable')
        ->middleware(['permission:show_orders']);

    Route::get('{id}', 'Dashboard\OrderController@showAbandonedCart')
        ->name('dashboard.abandoned_carts.show')
        ->middleware(['permission:show_orders']);

    Route::delete('{id}', 'Dashboard\OrderController@destroyAbandonedCart')
        ->name('dashboard.abandoned_carts.destroy')
        ->middleware(['permission:delete_orders']);

    Route::get('deletes', 'Dashboard\OrderController@deletesAbandonedCart')
        ->name('dashboard.abandoned_carts.deletes')
        ->middleware(['permission:delete_orders']);
});
