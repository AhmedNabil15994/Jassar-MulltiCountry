...
class OrderResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            'id'                   => $this->id,
            'unread'               => $this->unread,
            'total'                => $this->total . ' ' . $this->currency_data['selected_currency'],
            'shipping'             => $this->shipping . ' ' . $this->currency_data['selected_currency'] ,
            'subtotal'             => $this->subtotal . ' ' . $this->currency_data['selected_currency'],
