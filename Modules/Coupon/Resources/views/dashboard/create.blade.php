                            ...
                            <div class="tab-content">
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select name="discount_type" id="discount_type" class="form-control"
                                                    ...
                                                    <option value=""></option>
                                                    <option
                                                        value="value">   {{__('coupon::dashboard.coupons.form.value')}}</option>
                                                    <option
                                                        value="percentage">   {{__('coupon::dashboard.coupons.form.percentage')}}</option>
                                                </select>
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade in" id="custom">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group" id="countriesSection" style="display: none">
                                            <label class="col-md-2">
                                                {{ __('coupon::dashboard.coupons.form.countries') }}
                                            </label>
                                            <div class="col-md-9">
