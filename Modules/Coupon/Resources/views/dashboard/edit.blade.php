                            ...
                            <div class="tab-content">
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select name="discount_type" id="discount_type" class="form-control"
                                                    ...
                                                    <option value=""></option>
                                                    <option
                                                        value="value" {{($coupon->discount_type == "value") ? ' selected="" ' : ''}}>   {{__('coupon::dashboard.coupons.form.value')}}</option>
                                                    <option
                                                        value="percentage" {{($coupon->discount_type == "percentage") ? ' selected="" ' : ''}}>   {{__('coupon::dashboard.coupons.form.percentage')}}</option>
                                                </select>
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade in" id="custom">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="mt-radio-inline">
                                                    ...
                                                    <label class="mt-radio mt-radio-outline">
                                                        {{ __('coupon::dashboard.coupons.form.countries') }}
                                                        <input type="radio" name="coupon_flag" value="countries"
                                                            onclick="toggleCouponFlag('countries')"
                                                            {{ $coupon->flag == 'countries' ? 'checked' : '' }}>
                                                        <span></span>
                                                    </label>
                                                    <label class="mt-radio mt-radio-outline">
                                        ...
                                        <div class="form-group" id="countriesSection"
                                            style="{{ $coupon->flag == 'countries' ? 'display: block' : 'display: none' }}">
                                            <label class="col-md-2">
                                                {{ __('coupon::dashboard.coupons.form.countries') }}
                                            </label>
                                            <div class="col-md-9">
                                                <select name="country_ids[]" multiple id="single"
                                                        class="form-control select2" data-name="country_ids[]">
                                                    @foreach($countries as $code => $country)
                                                        @if((auth()->user()->is_internal && in_array($country->id , setting('supported_countries'))) ||
                                                            ...
                                                            <option data-currency="{{$country->currency->code}}" value="{{$country->id}}"
                                                                {{ $coupon->countries->contains($country->id) ? 'selected' : '' }}>{{$country->title}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                <div class="help-block"></div>
