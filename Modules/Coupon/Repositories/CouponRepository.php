...
class CouponRepository
{
    ...
    {
        $coupon = $this->coupon->with('countries', 'users', 'categories', 'products')->withDeleted()->find($id);
        return $coupon;
    }
    ...
    public function create($request)
    {
        ...
        try {
            ...
            if ($request->coupon_flag == 'countries' && $request['country_ids'])
                $this->countriesOfCouponSync($coupon, $request);
    ...
    public function countriesOfCouponSync($model, $request)
    {
        $model->countries()->sync($request['country_ids']);
        return true;
