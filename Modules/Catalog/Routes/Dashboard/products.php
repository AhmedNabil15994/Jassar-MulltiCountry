...
Route::group(['prefix' => 'products'], function () {
    ...
    Route::get('product/get-products-ajax', 'Dashboard\ProductController@getProductsAjax')
        ->name('dashboard.products.get-products-ajax')
        ->middleware(['permission:show_products']);
    ...
    Route::get('exports/{type}', 'Dashboard\ProductController@export')
