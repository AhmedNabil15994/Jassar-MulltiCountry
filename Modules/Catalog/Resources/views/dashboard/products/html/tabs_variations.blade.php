            ...
            @foreach ($product->variants as $key => $data)
                ...
                <tr role="row" class="filter" data-key="{{$data['id']}}">
                    ...
                    <td>
                        ...
                        <input type="text" placeholder="Price" class="form-control form-filter input-sm"
