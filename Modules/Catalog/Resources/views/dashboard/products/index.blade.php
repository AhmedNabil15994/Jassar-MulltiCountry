                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 300px;">{{ __('catalog::dashboard.products.datatable.title') }}</th>
                                        <th>{{ __('catalog::dashboard.products.datatable.vendor') }}</th>
                                        <th>{{ __('catalog::dashboard.products.datatable.categories') }}</th>
                                        <th>{{ __('user::dashboard.admins.create.form.country') }}</th>
...
responsivePriority:1,
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                @endpermission --}}
                                @if (setting('products.toggle_addons') == 1 && auth()->user()->can('show_product_addons'))
