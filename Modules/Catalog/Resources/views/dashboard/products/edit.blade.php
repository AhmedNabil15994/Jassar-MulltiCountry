            ...
            <div class="row">
                <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post"
                    ...
                    <div class="col-md-12">
                        ...
                        @if (setting('products.toggle_variations') == 1)
                                            ...
                                            <ul class="nav nav-pills nav-stacked">
                                                ...
                                                <li class="">
                                                    <a href="#stock" data-toggle="tab" id="click-stock"
                                                        style="display: {{ $product->product_flag == $productFlags::__default ? 'block' : 'none' }}">
                                                ...
                                                @if (setting('products.toggle_variations') == 1)
                                                    <li class="">
                                                        <a href="#variations" id="click-varaition" data-toggle="tab"
                                                            style="display: {{ $product->product_flag == $productFlags::__default ? 'none' : 'block' }}">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            @else
                                                <div class="col-md-9">
                                                    <span class="holder" style="margin-top:15px;max-height:100px;">
                                                        <img src="{{ $product->getFirstMediaUrl('images') }}" alt=""
                                                            style="height: 15rem;">
                                                    </span>
                                                </div>
                                            @endif
                                            ...
                                            @permission('pending_products_for_approval')
                                                <div class="form-group">
                                                    <label class="col-md-2">
                                                        {{ __('catalog::dashboard.products.form.pending_for_approval') }}
                                                    </label>
                                                    <div class="col-md-9">
                                                        <input type="checkbox" class="make-switch" data-size="small"
                                                            name="pending_for_approval"
                                                            {{ $product->pending_for_approval == 1 ? ' checked="" ' : '' }}>
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
                                            @endpermission
                                ...
                                <div class="tab-pane fade in" id="stock">
                                    <div id="stock-content"
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{ __('user::dashboard.admins.create.form.country') }}
                                                </label>
                                                <div class="col-md-9">
                                                    <select class="form-control select2" name="country_id">
                                                        @foreach($countries as $code => $country)
                                                            @if((auth()->user()->is_internal && in_array($country->id , setting('supported_countries'))) ||
                                                                ...
                                                                <option data-currency="{{$country->currency->code}}" value="{{$country->id}}" {{$product->country_id == $country->id ? 'selected' : ''}}>{{$country->title}}</option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                    <div class="help-block"></div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{ __('catalog::dashboard.products.form.price') }} (<b class="currency">{{$product->country->currency->code ?? ''}}</b>)
                                                </label>
                                                <div class="col-md-9">
                                            ...
                                            <h3 class="page-title">
                                                {{ __('catalog::dashboard.products.form.offer') }}
                                            </h3>
                                                        ...
                                                        <div class="mt-radio-inline">
                                                            <label class="mt-radio">
                                                                <input type="radio" name="offer_type"
                                                                    ...
                                                                    onclick="toggleOfferType('amount')"
                                                            ...
                                                            <label class="mt-radio">
                                                                <input type="radio" name="offer_type"
                                                                    ...
                                                                    {{ is_null($product->offer) || optional($product->offer)->percentage ? 'checked' : '' }}>
                                        ...
                                        <div id="variations-content"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="option_values"
                                                                ...
                                                                @foreach ($option->values as $value)
                                                                    <option
                                                                        @if ($product->checkIfHaveOption($value->id)) selected @endif
                                                                        value="{{ $value->id }}"
                                            ...
                                            <div style="display: none" id="result-add-option">
                                                <h2 class="text-center">
                                                    {{ __('catalog::dashboard.products.form.new_add') }}</h2>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="product-images">
                                                @if (count($product->getMedia('gallery')) > 0)
                                                    @foreach ($product->getMedia('gallery') as $k => $img)
                                                        <div id="prd-image-{{ $k }}"
                                                            class="prd-image-section">
...
@section('scripts')
    ...
    <script>
        ...
        $(function() {
            ...
            $('select[name="country_id"]').on('change',function (){
                console.log($(this).children("option:selected").data('currency'))
                $('b.currency').html($(this).children("option:selected").data('currency'));
            });

            @if($product->country_id != null)
            $('select[name="country_id"]').val("{{$product->country_id}}").trigger('change');
            @else
            $('select[name="country_id"]').val("{{Setting::get('default_country')}}").trigger('change');
            @endif
    ...
    <script>
            ...
            if (rowCountsArray.length > 1) {
                if (flag === 'db') {
                    ...
                    if (r == true) {
                        ...
                        $.ajax({
                            url: "{{ route('dashboard.products.delete_product_image') }}?id=" + rowId + "&product={{$product->id}}",
                            type: 'get',
                            dataType: 'JSON',
                            contentType: false,
                            cache: false,
        ...
        function onProductFlagChange(value) {
            let defaultValue = '{{ $productFlags::__default }}'; // single
