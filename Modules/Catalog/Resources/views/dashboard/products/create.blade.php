                                    ...
                                    <div id="collapse_2_1" class="panel-collapse in">
                                        <div class="panel-body">
                                            ...
                                            <ul class="nav nav-pills nav-stacked">
                                                ...
                                                @if (setting('products.toggle_variations') == 1)
                                                    <li class="">
                                                        <a href="#variations" id="click-varaition" style="display: none;"
                                                            data-toggle="tab">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade in" id="stock">
                                    <div id="stock-content">
                                        ...
                                        <div class="col-md-10">
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-control select2" name="country_id">
                                                        @foreach($countries as $code => $country)
                                                            ...
                                                            <option data-currency="{{$country->currency->code}}" value="{{$country->id}}">{{$country->title}}</option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                    <div class="help-block"></div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{ __('catalog::dashboard.products.form.price') }}  (<b class="currency"></b>)
                                                </label>
                                                <div class="col-md-9">
                                ...
                                @if (setting('products.toggle_variations') == 1)
                                    <div class="tab-pane fade in" id="variations">
                                        <div id="variations-content" style="display: none;">
...
@section('scripts')
    ...
    <script>
        ...
        $(function() {
            ...
            $('select[name="country_id"]').val("{{auth()->user()->country_id}}").trigger('change');
            @endif
