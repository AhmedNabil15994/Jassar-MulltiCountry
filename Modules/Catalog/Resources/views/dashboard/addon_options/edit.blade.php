...
@section('title', __('catalog::dashboard.addon_options.routes.update'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('catalog::dashboard.addon_options.routes.update')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post"
                      ...
                      action="{{route('dashboard.addon_options.update',$addonOption->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    <div class="col-md-10">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="title[{{$code}}]"
                                                                   ...
                                                                   value="{{$addonOption->getTranslation('title',$code)}}">
                                            ...
                                            <div class="col-md-9">
                                                <select name="addon_category_id"
                                                    ...
                                                    @foreach($sharedActiveAddonCategories as $k => $addonCategory)
                                                        <option
                                                            value="{{ $addonCategory->id }}" {{ $addonCategory->id == $addonOption->addon_category_id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="price" class="form-control"
                                                       data-name="price" value="{{ $addonOption->price }}">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-check">
                                                    <span style="margin: 10px;">
                                                        <input type="radio"
                                                               ...
                                                               {{ is_null($addonOption->qty) ? 'checked' : '' }}>
                                                    ...
                                                    <span style="margin: 10px;">
                                                        ...
                                                        <label class="form-check-label">
                                                         ...
                                                         <input type="number" id="prdQty" name="qty"
                                                                class="form-control"
                                                                value="{{ $addonOption->qty }}"
                                                                data-name="qty"
                                                                style="display: {{ !is_null($addonOption->qty) ? 'block' : 'none' }}">
                                                        <div class="help-block"></div>
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                @include('core::dashboard.shared.file_upload', ['image' => $addonOption->image])
                                                <div class="help-block"></div>
                                            </div>
                                        </div>

                                        @if ($addonOption->trashed())
                                            <div class="form-group">
                                                <label class="col-md-2">
                        ...
                        <div class="col-md-12">
                            <div class="form-actions">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{url(route('dashboard.addon_options.index')) }}" class="btn btn-lg red">
