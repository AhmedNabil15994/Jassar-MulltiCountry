                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('catalog::vendor.products.datatable.image')}}</th>
                                    <th>{{__('catalog::vendor.products.datatable.status')}}</th>
                                    <th style="width: 300px;">{{__('catalog::vendor.products.datatable.title')}}</th>
                                    <th>{{__('catalog::vendor.products.datatable.vendor')}}</th>
                                    <th>{{__('catalog::vendor.products.datatable.created_at')}}</th>
                                    <th>{{__('catalog::vendor.products.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
...
@include('apps::vendor.components.datatable.image-uploading.scripts',['uploading_route' => route('vendor.products.update.photo')])
                        ...
                        {data: 'id', className: 'dt-center'},
                        {
                            ...
                            render: function (data, type, row) {
                                return `<div id="photo_content_`+row.id+`">
                                            <span class="photo">
                                                <img  class="edit-photo" onclick="browseFile(`+row.id+`)" src="/images/icons/upload-image.svg"/>
...
responsivePriority:1,
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                // Edit
                                var addOnsUrl = '{{ route("vendor.products.add_ons", ":id") }}';
                                addOnsUrl = addOnsUrl.replace(':id', data);

                                return `
                                @if(setting('products.toggle_addons') == 1)
