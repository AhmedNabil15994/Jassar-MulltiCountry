...
@section('title', __('catalog::vendor.products.routes.add_ons'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="javascript:;">{{__('catalog::vendor.products.routes.add_ons')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <form id="addOnsForm" class="form-horizontal form-row-seperated" method="post"
                      enctype="multipart/form-data" action="{{route('vendor.products.store_add_ons',$product->id)}}">
                    @csrf
                    @method('POST')
                    <div class="col-md-12">
                                            ...
                                            <ul class="nav nav-pills nav-stacked">
                                                <li class="active">
                                                    <a href="#add_ons" data-toggle="tab">
                                                        {{ __('catalog::vendor.products.form.tabs.add_ons') }}
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active fade in" id="add_ons">
                                    {{--  <h3 id="pageTitle"
                                        class="page-title">{{ __('catalog::vendor.products.form.tabs.add_ons') }}</h3>  --}}
                                    <div class="col-md-10">
                                        ...
                                        @foreach (array_keys(config('laravellocalization.supportedLocales')) as $code)
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('catalog::vendor.products.form.add_ons.name')}}
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{ __('catalog::vendor.products.form.add_ons.type') }}
                                            </label>
                                            <div class="col-md-9">
                                                <div class="mt-radio-inline">
                                                    <label class="mt-radio mt-radio-outline"> {{ __('catalog::vendor.products.form.add_ons.single') }}
                                                        <input type="radio" id="singleType" name="add_ons_type"
                                                               value="single" checked>
                                                        <span></span>
                                                    </label>
                                                    <label class="mt-radio mt-radio-outline">
                                                        {{ __('catalog::vendor.products.form.add_ons.multiple') }}
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                            <tr>
                                                <th>{{__('catalog::vendor.products.form.add_ons.option')}}</th>
                                                <th>{{__('catalog::vendor.products.form.add_ons.price')}}</th>
                                                <th>{{__('catalog::vendor.products.form.add_ons.default')}}</th>
                                                <th></th>
                                            </tr>
                                            </thead>
                                                ...
                                                <td>
                                                    @foreach (array_keys(config('laravellocalization.supportedLocales')) as $code)
                                                        <input type="text"
                                                               ...
                                                               name="option[0][{{$code}}]"
                                                               autocomplete="off"
                                                               placeholder="{{__('catalog::vendor.products.form.add_ons.option')}} - {{ $code }}">
                                                    @endforeach
                                                </td>
                                        ...
                                        <div id="optionsCountRow" class="row" style="display: none;">
                                            <div class="col-md-12">
                                                <div class="pull-left">{{ __('catalog::vendor.products.form.add_ons.customer_can_select_exactly') }}
                                                ...
                                                <div class="pull-right">
                                                    <input id="options_count" name="options_count" type="number"
                                                           class="form-control"
                                                           disabled="disabled"
                                                           placeholder="{{ __('catalog::vendor.products.form.add_ons.options_count') }}">
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <a href="javascript:;" class="pull-left" onclick="addMoreOptions()"><i
                                                    class="fa fa-plus"></i> {{__('catalog::vendor.products.form.add_ons.add_more')}}
                                        </a>
                                        <button type="submit" id="submit" class="btn btn-success pull-right"><i
                                                    class="fa fa-save"></i> {{__('catalog::vendor.products.form.add_ons.save_options')}}
                                        </button>
                                        <a href="javascript:;" style="margin-left: 10px; margin-right: 10px;"
                                           class="pull-right"
                                           onclick="clearDefaults()"><i
                                                    class="fa fa-remove"></i> {{__('catalog::vendor.products.form.add_ons.clear_defaults')}}
                                        </a>
                                        <a id="resetForm" href="javascript:;"
                                           style="display: none; margin-left: 10px; margin-right: 10px;"
                                           class="pull-right"
                                           onclick="defaultMode()"><i
                                                    class="fa fa-refresh"></i> {{__('catalog::vendor.products.form.add_ons.reset_form')}}
                                        </a>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                            <tr>
                                                <th>{{__('catalog::vendor.products.form.add_ons.add_ons_name')}}</th>
                                                <th>{{__('catalog::vendor.products.form.add_ons.type')}}</th>
                                                <th>{{__('catalog::vendor.products.form.add_ons.created_at')}}</th>
                                                <th>{{__('catalog::vendor.products.form.add_ons.operations')}}</th>
                                            </tr>
                                            </thead>
                                                    ...
                                                    <tr id="addOnsRow-{{ $value->id }}">
                                                        ...
                                                        <td>
                                                            @if($value->type == 'single')
                                                                <span>{{ __('catalog::vendor.products.form.add_ons.single') }}</span>
                                                            @else
                                                                <span>{{ __('catalog::vendor.products.form.add_ons.multiple') }}</span>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0)" class="btn btn-primary"
                                                               ...
                                                               title="{{__('apps::vendor.general.edit_btn')}}"><i
                                                                        class="fa fa-edit"></i></a>

                                                            <a href="javascript:void(0)" class="btn btn-warning"
                                                               onclick="openAddOnsDetails('', {{ $value->id }}, {{ $product->addOns[$k] }})"
                                                               title="{{__('catalog::vendor.products.form.add_ons.show')}}"><i
                                                                        class="fa fa-eye"></i></a>

                                                            <a href="javascript:void(0)" class="btn btn-danger"
                                                               onclick="deleteMasterOptions({{ $value->id }}, 'db')"
                                                               title="{{__('apps::vendor.general.delete_btn')}}"><i
...
@section('scripts')
    ...
    <script>
        ...
        function assignAddOnsName(flag = '', data = {}) {
            ...
            if (flag === 'reset') {
                @foreach (array_keys(config('laravellocalization.supportedLocales')) as $k => $code)
