...
class CategoryController extends Controller
{
    ...
    public function productsCategory(Request $request,$countryPrefix, $slug = null)
    {
        if ($slug == null) {
            $category = null;
        } else {
        ...
        $products = $this->product->getProductsByCategory($request, $category, ["tags", "variants",'offer']);
