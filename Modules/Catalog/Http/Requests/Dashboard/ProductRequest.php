        ...
        switch ($this->getMethod()) {
            ...
            case 'POST':
                ...
                if ($this->product_flag == ProductFlag::Single) {
                    $result['price'] = 'required|numeric|min:0';
            ...
            case 'PUT':
                ...
                if (isset($this->edit_v_images) && !empty($this->edit_v_images)) {
                    $result['edit_v_images.*'] = 'mimes:jpeg,png,jpg,gif,svg|max:1024';
                }
