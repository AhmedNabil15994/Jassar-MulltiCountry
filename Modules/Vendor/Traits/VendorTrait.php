...
trait VendorTrait
{
    ...
    public function calculateVendorCommissions($orderVendors)
    {
        ...
        $upaymentKnetFixedAppCommission = setting('supported_payments.upayment.commissions.knet.fixed_app_commission');
        $upaymentKnetPercentageAppCommission = setting('supported_payments.upayment.commissions.knet.percentage_app_commission');
        $upaymentCcFixedAppCommission = setting('supported_payments.upayment.commissions.cc.fixed_app_commission');
        $upaymentCcPercentageAppCommission = setting('supported_payments.upayment.commissions.cc.percentage_app_commission');
