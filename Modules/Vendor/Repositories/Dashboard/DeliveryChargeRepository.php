...
class DeliveryChargeRepository
{
    ...
    public function update($request, $vendor)
    {
        ...
        try {
            ...
            if (isset($request->days_status) && !empty($request->days_status) && setting('other.select_shipping_provider') == 'vendor_delivery' && in_array('schedule', $vendor->delivery_time_types ?? [])) {
