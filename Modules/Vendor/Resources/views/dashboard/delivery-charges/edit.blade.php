                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="panel-group accordionTab" id="accordion">
                                ...
                                @if (in_array('schedule', $vendor->delivery_time_types ?? []))
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                        ...
                        <div class="col-md-9">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" name="delivery[]"
                                                                        ...
                                                                        placeholder="{{ __('vendor::dashboard.delivery_charges.update.charge') . Setting::get('default_currency') }}">
                            ...
                            @if (in_array('schedule', $vendor->delivery_time_types ?? []))
                                <div class="tab-content" id="deliveryTimesTabContent">
                                    @include('vendor::dashboard.vendors.delivery-times._edit_times')
