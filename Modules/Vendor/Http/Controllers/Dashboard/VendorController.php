...
class VendorController extends Controller
{
    ...
    public function update(VendorRequest $request,$countryPrefix, $id)
    {
        try {
    ...
    public function getAssignedProducts(Request $request,$countryPrefix, $id)
    {
        $vendor = $this->vendor->findById($id);
    ...
    public function assignProducts(VendorProductsRequest $request,$countryPrefix, $id)
    {
        try {
            $vendor = $this->vendor->findById($id);
            if (!$vendor)
