...
class VendorController extends Controller
{
    ...
    public function vendorBySection($countryPrefix,$slug)
    {
    ...
    public function show(Request $request, $countryPrefix,$slug)
    {
...
//        dd($vendor->toArray(), $categories->toArray());
    ...
    public function askForm($countryPrefix,$slug)
    {
        $vendor = $this->vendor->findBySlug($slug);
    ...
    public function askQuestion(AskQuestionRequest $request,$countryPrefix, $slug)
    {
        $vendor = $this->vendor->findBySlug($slug);
    ...
    public function prescriptionForm($countryPrefix,$slug)
    {
        $vendor = $this->vendor->findBySlug($slug);
    ...
    public function sendPrescription(PrescriptionRequest $request,$countryPrefix, $slug)
    {
        $vendor = $this->vendor->findBySlug($slug);
