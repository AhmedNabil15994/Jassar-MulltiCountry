...
class Local implements ShippingTransactionsInterface
{
    ...
    public function getDeliveryPrice(Request $request, Address $address = null, $userToken): object
    {
        ...
        if ($DeliveryCharge) {
            ...
            $data = [
                'original_price' => priceWithCurrenciesCode($price,true,false),
            ...
            return response()->json([
                'success' => false, 
                'data' => $data,
                'cart' => getCart(null,true),
                'errors' => __('catalog::frontend.checkout.validation.state_not_supported_by_company')], 422);
        }
    }
